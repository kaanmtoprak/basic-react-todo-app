...
import { Button, Box, Flex, Container, Text,useToast,
    Popover,
    PopoverTrigger,
    PopoverContent,
    PopoverHeader,
...
const TodoArea = () => {
  const {indexItem,setIndexItem, local, controlLocal, setControlLocal,setControldelete } = useTodos();
  ...
  return (
    <>
      ...
      {({  onClose }) => (
        <>
          <PopoverTrigger>
          <Button colorScheme="red" >Delete All<DeleteIcon ml="2"/></Button>
          </PopoverTrigger>
          <Portal>
            <PopoverContent>
              ...
              <PopoverBody>
                <Box>
                Are you sure to delete all todos mf* ?
                </Box>

              </PopoverBody>
              <PopoverFooter>
              <Button mr="2" size="sm" onClick={()=>handleDelete(onClose)} colorScheme='red'>Delete</Button>
        ...
        <>
          ...
          <Portal>
            <PopoverContent>
              ...
              <PopoverBody>
                <Box>
                Are you sure to delete this to do mf* ?
                </Box>

              </PopoverBody>
              <PopoverFooter>
              <Button mr="2" size="sm" onClick={()=>handleSlice(index,onClose)} colorScheme='red'>Delete</Button>
              <Button size="sm" onClick={onClose}>Close</Button>
              </PopoverFooter>
            </PopoverContent>
          </Portal>
